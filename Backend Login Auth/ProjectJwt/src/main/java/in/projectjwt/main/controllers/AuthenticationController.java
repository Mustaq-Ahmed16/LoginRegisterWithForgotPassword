...
//    }
    ...
    public ResponseEntity<Map<String, String>> signup(@RequestBody User user) {
        ...
        ResponseEntity<Map<String, String>> signupResponse = authenticationService.signup(user);
        ...
        response.put("message", signupResponse.getBody().get("message"));
        return ResponseEntity.status(HttpStatus.CREATED).body(response); // HTTP 201 Create
    }
    @PostMapping("/login")
